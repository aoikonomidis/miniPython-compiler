...
public final class AArgument extends PArgument
{
    ...
    private final LinkedList _idValue_ = new TypedLinkedList(new IdValue_Cast());
        ...
        List _idValue_)
    {
        ...
        {
            this._idValue_.clear();
            this._idValue_.addAll(_idValue_);
        }
    ...
    public LinkedList getIdValue()
    {
        return _idValue_;
    }

    public void setIdValue(List list)
    {
        _idValue_.clear();
        _idValue_.addAll(list);
    }
    ...
    void replaceChild(Node oldChild, Node newChild)
    {
        ...
        for(ListIterator i = _idValue_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
    ...
    private class IdValue_Cast implements Cast
    {
        public Object cast(Object o)
        {
            PIdValue node = (PIdValue) o;
