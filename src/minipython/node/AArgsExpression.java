...
public final class AArgsExpression extends PExpression
{
    private PValue _l_;
    private final LinkedList _r_ = new TypedLinkedList(new R_Cast());

    public AArgsExpression()
    {
    }
    ...
    {
        ((Analysis) sw).caseAArgsExpression(this);
    }
    ...
    private class R_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != AArgsExpression.this))
            {
                node.parent().removeChild(node);
            }
